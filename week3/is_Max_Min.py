...
def tester2(tree, curr_node, curr_level):
    if not has_left_child(tree, curr_node) and not has_right_child(tree, curr_node):
    ...
    if has_right_child(tree, curr_node):
        if curr_level % 2 == 1:
            min_subtree_right = tester(tree, 2*curr_node + 2, curr_level + 1)
        else:
            max_subtree_right = tester(tree, 2*curr_node + 2, curr_level + 1)
    ...
    if curr_level % 2 == 1:
        if min_subtree_left and min_subtree_right:
            ...
            if tree[curr_node] > min_elem:
                ...
                return max([min_subtree_left, min_subtree_right, tree[curr_node]])
        ...
        if min_subtree_left and min_subtree_right:
            ...
            if tree[curr_node] < max_elem:
                ...
                return min([min_subtree_left, min_subtree_right, tree[curr_node]])
        elif min_subtree_left:
            if tree[curr_node] > min_subtree_left:
                return False
            else:
